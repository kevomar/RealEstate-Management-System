...
<?php
          $ld_id = $_SESSION['ld_id'];
         $select = "SELECT * FROM `landlords` WHERE ld_id = '$ld_id'"; 
         $result = mysqli_query($conn, $select) or die;

         if(mysqli_num_rows($result) > 0){
            $fetch = mysqli_fetch_assoc($result) or die;
            $name = $fetch['ld_firstname']." ".$fetch['ld_lastname'];
    ...
    <div class="container-fluid mt-2 mb-2">
        <div class="col-lg-12">
            ...
            <div class="col-md-4 float-left text-white">
                <large><b>REMS PROPERTY MANAGMENT SYSTEM</b></large>
            </div>
