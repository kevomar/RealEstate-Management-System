            ...
            for($i=1;$i<=$rowcount;$i++)
            {
              ...
              if($i==1)
              {
                ...
                <div class="item active">
                  <img class="d-block img-fluid" src="uploadsforproperties/<?php echo $photo ?>" alt="First slide" width="100%" style="max-height: 600px; min-height: 600px;">
                </div>
                <?php 
              }
              else
